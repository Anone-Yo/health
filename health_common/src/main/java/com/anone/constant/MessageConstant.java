...
public class MessageConstant {
    ...
    public static final String DELETE_PIC_FAIL = "删除图片失败";
    public static final String DELETE_MENU_FAIL = "删除菜单失败";
    public static final String DELETE_PERMISSION_FAIL = "删除权限失败";
    public static final String SHOW_MENU_FAIL = "回显菜单失败";
    public static final String SHOW_PERMISSION_FAIL = "回显权限失败";
    ...
    public static final String SHOW_MENU_SUCCESS = "回显菜单成功";
    public static final String SHOW_PERMISSION_SUCCESS = "回显权限成功";
    public static final String EDIT_MENU_SUCCESS = "编辑菜单成功";
    public static final String DELETE_PIC_SUCCESS = "删除图片成功";
    ...
    public static final String IMPORT_ORDERSETTINGONE_FAIL = "导入单个预约设置数据失败";
    public static final String IMPORT_ORDERSETTINGONE_SUCCESS = "导入单个预约设置数据成功";
    ...
    public static final String QUERY_LOADING_FAIL = "页面加载失败，请重新刷新";
    public static final String QUERY_LINKING_SUCCESS = "查询关联成功";
    public static final String NONE_ORDERDATE = "没有该预约日期";
    public static  final String ORDER_FAIL="预约失败";
    public static  final String GENDER_SUCCESS="展示会员性别占比图表成功";
    public static  final String GENDER_FAIL="展示会员性别占比图表失败";
    public static  final String AGE_FAIL="展示会员年龄段占比图表失败";
    public static  final String AGE_SUCCESS="展示会员年龄段占比图表失败";
